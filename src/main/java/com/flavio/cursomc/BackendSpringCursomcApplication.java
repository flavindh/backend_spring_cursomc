...
import com.flavio.cursomc.enums.EstadoPagamento;
...
public class BackendSpringCursomcApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(BackendSpringCursomcApplication.class, args);
	}
